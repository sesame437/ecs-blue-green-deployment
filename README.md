...
Here are the inputs required to launch CloudFormation templates:
  * **S3 Bucket**: Enter S3 Bucket for storing your CloudFormation templates and scripts(yaml files of templates should be store in a templates folder, and files of templates(include templates folder) & scripts(not include templates folder) should be compress as zip file and store in root of bucket). This bucket must be in the same region where you wish to launch all the AWS resources created by this example.
